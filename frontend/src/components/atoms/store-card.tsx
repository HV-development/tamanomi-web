      ...
      <div className="pt-2">
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-3 py-3 bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-700 rounded-xl transition-all duration-300 border border-gray-200 hover:border-gray-300"
            aria-label="店舗詳細"
          >
