...
export function CouponConfirmationPage({ coupon, onConfirm, onCancel, onLogoClick }: CouponConfirmationPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 flex flex-col justify-center p-6">
        <div className="w-full max-w-xs mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-xl border-4 border-green-400 overflow-hidden">
            ...
            <div className="bg-green-600 p-4 text-white text-center">
              <h3 className="text-base font-bold">クーポン使用確認</h3>
            </div>
            ...
            <div className="p-5">
              ...
              <div className="space-y-4">
                <button
                  onClick={onConfirm}
                  className="w-full bg-green-600 hover:bg-green-700 text-white py-4 px-4 rounded-xl font-bold text-base transition-colors shadow-md hover:shadow-lg"
                >
                  確定する
                </button>
                <button
