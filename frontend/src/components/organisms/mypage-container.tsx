          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-gray-900">{currentRankInfo.label}</div>
                  <div className="text-sm text-gray-600">{currentRankInfo.description}</div>
                </div>
              </div>
            </div>
            ...
            {nextRank && monthsToNext !== null ? (
              <div>
                <div className="text-sm text-gray-600 mb-2">次のランクアップまで</div>
                <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                  <div className="text-center space-y-2">
                    <div className="text-lg font-bold text-green-900">あと{monthsToNext}ヶ月</div>
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <div className="text-left">
                        <div className="font-bold text-green-900">{nextRank.label}ランク</div>
                        <div className="text-sm text-green-700">にランクアップ！</div>
                      </div>
                    </div>
                  </div>
                </div>
