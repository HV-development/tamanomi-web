        ...
        <div className="bg-white rounded-2xl border border-green-200 p-4">
          ...
          <div className="space-y-4">
            ...
            {nextRank && monthsToNext !== null ? (
              <div className="space-y-3">
                <div className="bg-green-500 text-white rounded-full py-3 px-6 text-center mx-auto">
              ...
              <div className="space-y-3">
                ...
                <div className="text-center">
                  <div className="text-base text-gray-700">🎉 最高ランク達成！</div>
                  <div className="text-base font-bold text-gray-900">レジェンドメンバーです</div>
                </div>
              </div>
            )}
          </div>
