      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg p-6 mb-6">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-bold text-gray-900 mb-2">iOS（iPhone）の場合</h3>
            ...
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Androidの場合</h3>
              <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-bold text-gray-900 mb-3">ステップ1: アプリを開く</h3>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-bold text-gray-900 mb-3">ステップ2: マイページにアクセス</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-bold text-gray-900 mb-3">ステップ3: ユーザーIDを確認</h3>
                  <p className="text-gray-700 text-sm">
                    マイページ内に「ユーザーID」が表示されます。このIDをコピーしてください。
                  </p>
                </div>
                
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-bold text-gray-900 mb-3">ステップ4: IDをコピー</h3>
                  <p className="text-gray-700 text-sm">
                    ユーザーIDをタップすると自動的にコピーされます。
                  </p>
                </div>
                
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-bold text-gray-900 mb-3">ステップ5: プラン登録画面で入力</h3>
                  <p className="text-gray-700 text-sm">
                    コピーしたユーザーIDをプラン登録画面の入力欄に貼り付けてください。
                  </p>
                </div>
              </div>
            </div>
